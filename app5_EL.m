...
K_AvPh_B = 1/abs(evalfr(FTBO_EL, j*wg_B_EL));


[Gm_EL Pm_EL wgm wpm] = margin(K_AvPh_B*FTBO_EL);

phi_AvPh_EL_B = (des_PM_B+mrg_PM_EL) - Pm_EL;
alpha_EL_B = ( 1-sind(phi_AvPh_EL_B) )/( 1+sind(phi_AvPh_EL_B) );
T_EL_B = 1/(wg_B_EL*sqrt(alpha_EL_B));
...
T_EL_Re_B = 10/wg_B_EL;

z = -1/T_EL_Re_B;
% z = -0.68
p = -1/(K_RePh_B*T_EL_Re_B);

Kr_EL_B = 1/abs((j*wg_B_EL - z)/(j*wg_B_EL-p));
 Kr_EL_B = 1
